...
#-------------------------------------------------------------------------------------#
''' Makeshift script used to show time-varied frequency analysis of a single recording '''
#-------------------------------------------------------------------------------------#

# Split audio signal into n parts
...
# Tweaked spectrum algorithm to do spectrum on each of n parts
...
# Get maximum spectrum(peaks) based on single recordings
def get_max(nparray):
    last = nparray[0]
    current = nparray[1]
    maxlist = []
